	...
	var smoothScroll = function (element, options) {
		$timeout(function(){
			var startLocation = window.pageYOffset,
				timeLapsed = 0,
        runAnimation, percentage, position;
			...
			var animateScroll = function () {
				...
				if ( position != endLocation && window.pageYOffset != endLocation && ( (window.innerHeight + window.pageYOffset) < document.body.scrollHeight ) ) {
